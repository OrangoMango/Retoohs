...
public class HomeScreen{
	...
	private Image logo = AssetLoader.getInstance().getImage("logo.png");
	...
	public StackPane getLayout(){
		...
		this.buttons.add(new MenuButton(gc, 250, 300, 150, 50, AssetLoader.getInstance().getImage("button_play.jpg"), () -> {
			this.loop.stop();
		...
		this.buttons.add(new MenuButton(gc, 250, 375, 150, 50, AssetLoader.getInstance().getImage("button_play_tutorial.jpg"), () -> {
			this.loop.stop();
			if (this.mediaPlayer != null) this.mediaPlayer.stop();
			GameScreen gs = new GameScreen(true); // With tutorial
			MainApplication.stage.getScene().setRoot(gs.getLayout());
		}));
		this.buttons.add(new MenuButton(gc, 250, 450, 150, 50, AssetLoader.getInstance().getImage("button_credits.jpg"), () -> {
			this.loop.stop();
			if (this.mediaPlayer != null) this.mediaPlayer.stop();
		...
		MenuSlider musicSlider = new MenuSlider(gc, 550, 315, 200, 30, AssetLoader.getInstance().getImage("icon_music.png"), v -> {
		...
		MenuSlider sfxSlider = new MenuSlider(gc, 550, 375, 200, 30, AssetLoader.getInstance().getImage("icon_sfx.png"), v -> MainApplication.sfxVolume = v);
